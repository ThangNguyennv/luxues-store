Dự án Luxues Store (Website E-commerce Thời trang Full-Stack)
...
Mở một terminal, cd vào thư mục back-end:
...
Tạo file .env ở gốc thư mục back-end và điền các biến môi trường:
...
Mở một terminal thứ hai, cd vào thư mục front-end:
...
Tạo file .env.development ở gốc thư mục front-end:
