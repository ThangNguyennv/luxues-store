...
// req.query => Lấy sau dấu hỏi chấm
// req.params => object chứa các route động (ví dụ ở dưới là status và id)
...
module.exports.product = async (req, res) => {
  ...
  // Pagination
  const countProducts = await Product.countDocuments(find); // Đứng trước model, ở đây là 'Product' là thêm await
